      ...
      <Tabs.Screen
        ...
        listeners={{
          tabPress: (e) => {
            ...
            console.log(
              "Tab Adicionar premida. Ecrã atual nas tabs:",
              currentScreenNameInTabs,
              "Amigo atual do contexto:",
              currentFriend
            );
            ...
            console.log(
              "Tab Adicionar premida. Segmentos atuais dentro de (tabs):",
              segments
            );
            console.log("Diretorio da tab atual:", currentFolderName);
            console.log(
              "Ecrã da tab atual (primeiro segmento):",
              currentScreenName
            );
            console.log(
              `A navegar para adicionar despesa para o POTENCIAL amigo: ${potentialId}`
            );

            if (
              currentFolderName === "(tabs)" &&
              currentScreenName === "friend" &&
              potentialId === "[friendId]"
            ) {
              // Estamos no ecrã de despesas de um amigo específico
              const friendId = potentialId;
              console.log(
                `A navegar para adicionar despesa para o amigo: ${currentFriend?.name}`
              );
              ...
              // Inclui o caso de estar em 'index' (Amigos) ou outro ecrã de tab
